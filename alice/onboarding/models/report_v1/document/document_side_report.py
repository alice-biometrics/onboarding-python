...
from alice.onboarding.models.report_v1.document.document_side import DocumentSide
from alice.onboarding.models.report_v1.document.document_side_report_meta import (
    DocumentSideReportMeta,
)
from alice.onboarding.models.report_v1.shared.href import Href
...
class DocumentSideReport(BaseModel):
    ...
    def get_field(self, field_name: str) -> Result[ReportV1Field, Failure]:
